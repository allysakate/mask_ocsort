...
from models.layers import BezierAlign
from models.structures import Beziers
...
class TopPooler(ROIPooler):
    ...
    def forward(self, x, box_lists):
        ...
        output = torch.zeros(
            (num_boxes, num_channels, output_size[0], output_size[1]),
            dtype=dtype,
            device=device,
        )

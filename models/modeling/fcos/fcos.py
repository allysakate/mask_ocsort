...
from models.layers import DFConv2d, NaiveGroupNorm
from models.utils.comm import compute_locations
    ...
    def forward(self, images, features, gt_instances=None, top_module=None):
        ...
        if self.training:
            results, losses = self.fcos_outputs.losses(
                logits_pred, reg_pred, ctrness_pred, locations, gt_instances, top_feats
            )

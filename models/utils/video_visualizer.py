...
class VideoVisualizer:
    ...
    def draw_instance_predictions(self, frame, predictions, class_list):
        """
        ...
        vehicle_classes = class_list
        class_mask = np.isin(classes, vehicle_classes)
        ...
        colors = predictions.COLOR if predictions.has("COLOR") else [None] * len(boxes)
        ...
        # print(f"scores: {scores} - {len(scores)}")
        # print(f"classes: {classes} - {len(classes)}")
        # print(f"keypoints: {keypoints}")
        # print(f"colors: {colors} - {len(colors)}")
        # print(f"periods: {periods}")
        # print(f"period_threshold: {period_threshold}")
        # print(f"visibilities: {visibilities} - {len(visibilities)}")

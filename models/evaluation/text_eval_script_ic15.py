...
from models.evaluation import rrc_evaluation_funcs_ic15 as rrc_evaluation_funcs
import importlib
...
def evaluate_method(gtFilePath, submFilePath, evaluationParams):
    ...
    def include_in_dictionary(transcription):
        """
        Function used in Word Spotting that finds if the Ground Truth transcription meets the rules to
        enter into the dictionary. If not, the transcription will be cared as don't care
        """
